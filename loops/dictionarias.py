...
cars = [    #רשימה של דיקשינורי- הנקודתיים הופכות את זה לדיקשינורי
...
human_philip = {  #דיקשינורי שמתאר את הישות פיליפ 
    "name": "Philip",
    "age": 24,
    "color": "ASHKENAZ",
...
philip_list = [ # דרך לאר טובה לייצג ישות בצורה של רשימה
    ("name", "Philip"),
    ("age", 24),
    ("color", "ASHKENAZ"),
    ("occupation", "Junior DevOps Engineer"),
...
print(philip_list[1][1]) # הגישה לנתונים היא לא נוחה כשהם שמורים ברשימה
print(human_philip["age"])# כשזה שמור כישות דיקשינרי הרבה יותר קל לגשת 